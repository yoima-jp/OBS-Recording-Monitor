	...
	public void onInitializeClient() {
		...
		ScreenEvents.AFTER_INIT.register((client, screen, width, height) -> {
			if (screen instanceof OptionsScreen) {
				...
				Button button = Button.builder(Component.translatable("screen.reccheck.button.open_short"), b -> client.gui.setScreen(new ConfigScreen(screen, configManager, obsConnectionManager)))
