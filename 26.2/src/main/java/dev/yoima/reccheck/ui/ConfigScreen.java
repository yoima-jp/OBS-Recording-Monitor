...
public final class ConfigScreen extends Screen {
	...
	protected void init() {
		...
		helpButton = addRenderableWidget(Button.builder(Component.translatable("screen.reccheck.button.help_short"), button -> Minecraft.getInstance().gui.setScreen(new HelpScreen(this))).bounds(footerLeftX + (footerButtonWidth + footerButtonGap), footerY, footerButtonWidth, 20).build());
