...
public final class RecCheckClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		HudRenderCallback.EVENT.register((graphics, tickDelta) -> hudRenderer.render(graphics, tickDelta));
		...
		ScreenEvents.AFTER_INIT.register((client, screen, width, height) -> {
			if (screen instanceof OptionsScreen) {
				...
				if (doneY != Integer.MAX_VALUE && doneButton instanceof net.minecraft.client.gui.components.AbstractWidget widget) {
